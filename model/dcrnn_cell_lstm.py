...
class DCGRUCell(RNNCell):
    ...
    def __call__(self, inputs, state, scope=None):
        """Long Short-Term Memory cell (LSTM) with Graph Convolution.
        ...
        with tf.variable_scope(scope or "dclstm_cell"):
            with tf.variable_scope("gates"):  # Forget gate, input gate, output gate, and candidate value.
                ...
                f, i, o, c = tf.split(value=value, num_or_size_splits=4, axis=-1)
