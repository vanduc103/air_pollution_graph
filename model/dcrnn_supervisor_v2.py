...
from model.dcrnn_model_v2 import DCRNNModel
...
class DCRNNSupervisor(object):
    ...
    def __init__(self, adj_mx, **kwargs):
        ...
        # Data preparation
        self._data = utils.load_dataset_v2(**self._data_kwargs)
    ...
    def run_epoch_generator(self, sess, model, data_generator, return_output=False, training=False, writer=None):
        ...
        for _, (x, w_x, tf_x, sp_x, ch_x, y) in enumerate(data_generator):
            feed_dict = {
                model.inputs: x,
                model.inputs_weather: w_x,
                model.inputs_traffic: tf_x,
                model.inputs_speed: sp_x,
                model.inputs_china: ch_x,
                model.labels: y,
            }
